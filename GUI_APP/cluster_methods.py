...
def selective_clustering(dataset,area_type, area_name, year):
    ...
    if(input_.shape[0] > 2 ):
            ...
            Visualise_Clusters(points_pca.values, centroids_pca, labels_pca, 'PCA and Kmeans at '+ area_type+ ' '+area_name+' '+str(year) )
            ...
            Visualise_Clusters_dbscan(res_pca_all.values, clusters , 'PCA and DBSCAN at '+ area_type+ ' '+area_name+' '+str(year) )
